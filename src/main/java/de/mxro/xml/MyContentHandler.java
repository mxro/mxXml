 ...
 *
 */
public class MyContentHandler implements ContentHandler, LexicalHandler {
   ...
   private String defaultNamespace="";
     ...
     */
    public static MyContentHandler createXMLOutput(XMLReader xmlReader) {
        final MyContentHandler output = new MyContentHandler(xmlReader.getContentHandler());
        ...
        for (final String element : LEXICAL_HANDLER_NAMES) {
            try {
            	...
            	de.mxro.utils.log.UserError.singelton.log("error setting lexical handler properties");
            }
        }
        return output;
    }
     ...
     */
    public static MyContentHandler createXMLOutput(Writer writer) {
     ...
     */
    public static MyContentHandler createXMLOutput(Writer writer, boolean escapeText)
    {
     ...
     */
    public static MyContentHandler createXMLOutput(OutputStream out) throws UnsupportedEncodingException {
     ...
     * if the underlying output is XML or could be false if the underlying output is textual.
     */
    public static MyContentHandler createXMLOutput(OutputStream out, boolean escapeText) throws UnsupportedEncodingException {
     ...
     */
    public static MyContentHandler createDummyXMLOutput() {
        return new MyContentHandler(new DefaultHandler());
    }
    ...
    public void startElement(
        ...
        if (this.getDefaultNamespace() != "" && atts instanceof AttributesImpl) {
        	((AttributesImpl) atts).addAttribute("", "", "xmlns", "CDATA", this.getDefaultNamespace());
        }
        // System.out.println("here "+this.getDefaultNamespace());
    ...
    public void startElement(String localName) throws SAXException {
        if (this.getDefaultNamespace() != "") {
        	...
        	atts.addAttribute("", "", "xmlns", "CDATA", this.getDefaultNamespace());
        	this.startElement("", localName, localName, atts);
        } else {
    ...
    public void startElement(String localName, Attributes attributes) throws SAXException {
       if (this.getDefaultNamespace() != "" && attributes instanceof AttributesImpl) {
		((AttributesImpl) attributes).addAttribute("", "", "xmlns", "CDATA", this.getDefaultNamespace());
	}
     ...
     */
    protected static MyContentHandler createXMLOutput(final XMLWriter xmlWriter) {
        final MyContentHandler answer = new MyContentHandler() {
            @Override
			public void close() throws IOException {
                xmlWriter.close();
            }
       ...
       /* try {
			xmlWriter.setFeature("http://xml.org/sax/features/namespaces", true);
